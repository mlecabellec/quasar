...
- [REVIEW-00001.2] Review of the whole [FE-0010] feature, including:
  - [FE-0010.1] Provide, for each basic numeric type (int, long, float, double, signed and unsigned, with various sizes), a class which is assignable to its basic type. 
      ...
      - [FE-0010.1.2] Each class related to a basic numeric type shall be derived from a common "Number" base class.
...
- [REVIEW-00001.4], regarding [FE-0010.1.2], quasar::coretypes::Integer template class is derived from quasar::coretypes::Number template class. It's compliant with [FE-0010.1.2].
