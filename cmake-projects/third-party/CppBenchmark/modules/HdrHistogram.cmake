if(NOT TARGET HdrHistogram)
  ...
  # Module library
  file(GLOB SOURCE_FILES "${CMAKE_CURRENT_LIST_DIR}/../../HdrHistogram/src/*.c")
  ...
  target_include_directories(HdrHistogram PUBLIC "${CMAKE_CURRENT_LIST_DIR}/../../HdrHistogram/include")
