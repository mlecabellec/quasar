...
*   The file `ai64/src/ai64.c` contains the main driver source code.
*   The file `ai64/src/ai64_ioctl.h` defines the ioctl commands used to communicate with the driver.
*   The file `ai64/src/plx_regs.h` contains register definitions for the PLX PCI bridge chip.
