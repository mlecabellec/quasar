// $URL: http://subversion:8080/svn/gsc/trunk/drivers/gsc_common/driver/linux/os_kernel_5.h $
// $Rev: 52470 $
...
#ifndef	__OS_KERNEL_5_H__
#define	__OS_KERNEL_5_H__
...
#define	HAVE_UNLOCKED_IOCTL				1
...
#ifdef	fallthrough							// for the 5.9 kernel's "fallthrough" macro
	...
	#define	PCI_SET_DMA_MASK(dev,mask)		dma_set_mask(&(dev)->pci.pd->dev,(u64)(mask))
#else
