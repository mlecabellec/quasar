// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/OPTO16X16/OPTO16X16_Linux_1.x.x.x_GSC_DN/samples/sbtest/wait_cancel.c $
// $Rev: 51414 $
...
*	Purpose:
*
*		Perform a test of the IOCTL service OPTO16X16_IOCTL_WAIT_CANCEL.
*
*	Arguments:
*
...
int wait_cancel_test(int fd)
{
	...
	gsc_label("OPTO16X16_IOCTL_WAIT_CANCEL");
