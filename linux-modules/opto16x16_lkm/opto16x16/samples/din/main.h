// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/OPTO16X16/OPTO16X16_Linux_1.x.x.x_GSC_DN/samples/din/main.h $
// $Rev: 53720 $
...
typedef struct
{
	...
	s32	ms_wait;		// Wait between readings?
	int	qty;			// Number of devices detected.
	s32	seconds;		// Monitor the inputs for this long.
	s32	share;
