// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AI64SSA/samples/id/main.c $
// $Rev: 54957 $
// $Date: 2024-08-07 15:52:23 -0500 (Wed, 07 Aug 2024) $
...
static int _parse_args(int argc, char** argv, args_t* args)
{
	const gsc_arg_item_t	list[]	=
	{
		...
		{	GSC_ARG_S32_FLAG,	&args->detail,			"-d",		{ 1 },	"Print out a detailed register dump."			},
	...
	{
		/* name	*/	"id",
		/* desc	*/	"Identify the specified device.",
