// $URL: http://subversion:8080/svn/gsc/trunk/drivers/gsc_common/utils/pci_plx/gsc_util_reg_pex8111.c $
// $Rev: 50955 $
// $Date: 2022-04-06 06:42:06 -0500 (Wed, 06 Apr 2022) $

// PEX8111: OS & Device Independent: Utility: source file
...
static gsc_reg_def_t	_pci[]	=
{
	...
	{ _PCI_REG(CPR),		"Capabilities Pointer Register"						},
...
//*****************************************************************************
int gsc_reg_pex8111_list_pci(int fd, int (func)(int fd, int index, int verbose, u32 reg, u32* value))
{
	int	errs;

	gsc_label("PEX8111 PCI Registers");
	printf("\n");
...
//*****************************************************************************
int gsc_reg_pex8111_list_plx(int fd, int (func)(int fd, int index, int verbose, u32 reg, u32* value))
{
	int	errs;

	gsc_label("PEX8111 PLX Registers");
	printf("\n");
