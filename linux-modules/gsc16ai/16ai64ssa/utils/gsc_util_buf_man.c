...
// $Rev: 54937 $
// $Date: 2024-08-07 15:15:08 -0500 (Wed, 07 Aug 2024) $
...
static void _ll_stats(const local_list_t* ll, int threads)
{
	...
	gsc_label_long_comma(ll->stats.present.qty);
	printf("\n");
	...
	if (threads)
	{
		...
		gsc_label_long_comma(ll->stats.waiting.qty);
		printf("\n");
