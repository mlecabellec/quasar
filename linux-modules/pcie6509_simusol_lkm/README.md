...
This is the second driver for the NI PCIe-6509 in this repository. The other is `pcie6509_lkm`, which was developed by Concurrent Computer Corporation. This "simusol" version appears to be a separate, independent implementation from Astrium.
...
*   This driver is a separate implementation from the one in the `pcie6509_lkm` directory.
