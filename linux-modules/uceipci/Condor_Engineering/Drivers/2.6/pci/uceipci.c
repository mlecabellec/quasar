 ...
 *============================================================================*
 *
 *      COPYRIGHT (C) 2005 - 2016 BY ABACO SYSTEMS, INC.
 *      ALL RIGHTS RESERVED.
 *
 ...
 *             avionics PCI products and the Linux kernel 2.6.x.  It performs
 *             the necessary functions (registering, memory mapping,..)
 *             needed to operate in a Linux operating system.
 *
 *             This module is utilized by multiple Abaco Systems avionics
 *             products, use care when performing modifications.
 * 
 *
...
/* $Revision:  1.25 Release $
  ...
  01/14/2014   added support for R15-PMC. bch
