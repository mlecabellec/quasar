...
This module works in conjunction with the `ec_generic` module to provide a complete EtherCAT master solution.

*   **`ec_master` (this module):** Implements the high-level EtherCAT master protocol and logic.
*   **`ec_generic`:** Provides the low-level interface to the physical Ethernet hardware.
...
*   This module is the core of the IgH EtherCAT Master stack and depends on the `ec_generic` module.
