...
#define EC_IOCTL_SLAVE_SET_FSYNC_COUNT EC_IOW(0x80, ec_ioctl_slave_set_fsync_count_t)
#define EC_IOCTL_SLAVE_SET_FSYNC       EC_IOW(0x81, ec_ioctl_slave_set_fsync_t)
#endif
...
typedef struct {
    uint16_t slave_position;
    uint8_t count;
} ec_ioctl_slave_set_fsync_count_t;
