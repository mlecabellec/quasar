...
/* Ceci est une coquille vide necessaire a faire taire les messages      */
/* d'erreurs de gcc lorsque l'on ne souhaite pas afficher les messages   */
/* de debug. Ceci permet de reduire de maniere considerable les WARNING, */
/* ainsi, on peut s'attarder sur les vrais erreurs.                      */
static int	dprintf(char * str, ...)
{
  return (0);
}
