...
unsigned int forced_sync_count;
bool isCompletelyConfigured;
bool* isConfigured;
ec_sync_t* forced_syncs;
} forced_slave_syncs_t;
#endif
...
#ifdef EC_MASTER_SYNC_CONFIG_CAP
unsigned int countForcedSlaves;
forced_slave_syncs_t* forcedSlavesSyncs;
#endif
};
