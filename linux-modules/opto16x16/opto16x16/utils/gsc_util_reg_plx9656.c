// $URL: http://subversion:8080/svn/gsc/trunk/drivers/gsc_common/utils/pci_plx/gsc_util_reg_plx9656.c $
// $Rev: 50955 $
// $Date: 2022-04-06 06:42:06 -0500 (Wed, 06 Apr 2022) $

// PCI9656: OS & Device Independent: Utility: source file
...
#define	_PCI_REG(a)	"PCI " #a, GSC_PCI_9656_##a, 0, 0, 0, 0
#define	_PLX_REG(a)	"PLX " #a, GSC_PLX_9656_##a, 0, 0, 0, 0
...
static gsc_reg_def_t	_pci[]	=
{
	...
	{ _PCI_REG(VPDIDR),		NULL	},
	{ _PCI_REG(VPD_NEXT),	NULL	},
	{ _PCI_REG(VPDAD),		NULL	},
	{ _PCI_REG(VPDATA),		NULL	},
	{ NULL	}
};
...
static gsc_reg_def_t	_plx[]	=
{
	...
	{ _PLX_REG(OPLFIS),		NULL	},
	{ _PLX_REG(OPLFIM),		NULL	},
	{ _PLX_REG(IQP),		NULL	},
	{ _PLX_REG(OQP),		NULL	},
	{ _PLX_REG(MQCR),		NULL	},
	{ _PLX_REG(QBAR),		NULL	},
...
//*****************************************************************************
int gsc_reg_plx9656_list_pci(int fd, int (func)(int fd, int index, int verbose, u32 reg, u32* value))
{
	int	errs;

	gsc_label("PCI9656 PCI Registers");
	printf("\n");
...
//*****************************************************************************
int gsc_reg_plx9656_list_plx(int fd, int (func)(int fd, int index, int verbose, u32 reg, u32* value))
{
	int	errs;

	gsc_label("PCI9656 PLX Registers");
	printf("\n");
