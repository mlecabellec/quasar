// $URL: http://subversion:8080/svn/gsc/trunk/drivers/gsc_common/utils/pci_plx/gsc_util_reg_plx9080.c $
// $Rev: 50955 $
// $Date: 2022-04-06 06:42:06 -0500 (Wed, 06 Apr 2022) $

// PCI9080: OS & Device Independent: Utility: source file
...
#define	_PCI_REG(a)	"PCI " #a, GSC_PCI_9080_##a, 0, 0, 0, 0
#define	_PLX_REG(a)	"PLX " #a, GSC_PLX_9080_##a, 0, 0, 0, 0
...
static gsc_reg_def_t	_pci[]	=
{
	...
	{ _PCI_REG(BAR5),	NULL	},
	{ _PCI_REG(CIS),	NULL	},
	{ _PCI_REG(SVID),	"Subsystem Vendor ID Register"	},
	{ _PCI_REG(SID),	"Subsystem ID Register"	},
	{ _PCI_REG(ERBAR),	NULL	},
	{ _PCI_REG(ILR),	NULL	},
	{ _PCI_REG(IPR),	NULL	},
	{ _PCI_REG(MGR),	NULL	},
...
//*****************************************************************************
int gsc_reg_plx9080_list_pci(int fd, int (func)(int fd, int index, int verbose, u32 reg, u32* value))
{
	int	errs;
...
//*****************************************************************************
int gsc_reg_plx9080_list_plx(int fd, int (func)(int fd, int index, int verbose, u32 reg, u32* value))
{
	int	errs;
