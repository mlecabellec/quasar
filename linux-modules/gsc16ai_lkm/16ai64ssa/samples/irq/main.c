// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AI64SSA/samples/irq/main.c $
// $Rev: 54958 $
// $Date: 2024-08-07 15:52:38 -0500 (Wed, 07 Aug 2024) $
...
static int _parse_args(int argc, char** argv, args_t* args)
{
	...
	{
		/* name	*/	"irq",
		/* desc	*/	"Interrupt test application.",
