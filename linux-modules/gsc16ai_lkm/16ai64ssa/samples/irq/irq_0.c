// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AI64SSA/samples/irq/irq_0.c $
// $Rev: 53544 $
...
//*****************************************************************************
static int _irq0_initialize_test(int fd)
{
	int	errs;

	gsc_label("Initialize");
	errs	= irq_wait_test(fd, 0, AI64SSA_WAIT_GSC_INIT_DONE, 0, _init);
	return(errs);
}
...
//*****************************************************************************
static int _irq0_autocal_test(int fd)
{
	int	errs;

	gsc_label("Autocalibrate");
	errs	= irq_wait_test(fd, 0, AI64SSA_WAIT_GSC_AUTOCAL_DONE, 0, _autocal);
	return(errs);
}
...
//*****************************************************************************
static int _irq0_sync_start_test(int fd)
{
	int	errs;

	gsc_label("SYNC Start");
	errs	= irq_wait_test(fd, 0, AI64SSA_WAIT_GSC_SYNC_START, 0, _sync_start);
	return(errs);
}
...
//*****************************************************************************
static int _irq0_sync_done_test(int fd)
{
	int	errs;

	gsc_label("SYNC done");
	errs	= irq_wait_test(fd, 0, AI64SSA_WAIT_GSC_SYNC_DONE, 0, _sync_done);
	return(errs);
}
...
//*****************************************************************************
static int _irq0_burst_start_test(int fd)
{
	int	errs;

	gsc_label("Burst Start");
	errs	= irq_wait_test(fd, 0, AI64SSA_WAIT_GSC_BURST_START, 0, _burst_start);
	return(errs);
}
...
//*****************************************************************************
static int _irq0_burst_done_test(int fd)
{
	int	errs;

	gsc_label("Burst Done");
	errs	= irq_wait_test(fd, 0, AI64SSA_WAIT_GSC_BURST_DONE, 0, _burst_done);
	return(errs);
}
...
int irq_0_test(int fd)
{
	...
	errs	+= _irq0_initialize_test(fd);
	errs	+= _irq0_autocal_test(fd);
	errs	+= _irq0_sync_start_test(fd);
	errs	+= _irq0_sync_done_test(fd);
	errs	+= _irq0_burst_start_test(fd);
	errs	+= _irq0_burst_done_test(fd);
