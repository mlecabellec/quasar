...
*   The driver is split into several files, with `pcigSkel.c` providing the main skeleton and `digicool_lkm` being a specific implementation for the "digicool" device.
