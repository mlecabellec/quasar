...
ASDCEVT_CC_SUPPRIMER : Fonction ioctl de deconnexion d'une commande
                       codee d'un CEVT.
...
long
do_ASDCEVT_CC_SUPPRIMER(int vfxNum, int asdcNum, struct asdc_varg *dst, unsigned long arg)
{
    ...
    spin_lock(&dst->cevt_lock); /* Debut section critique */
        ...
        dst->cocor[e->bus][e->adresse][code].cevt = 0;
    ...
    *                 us de temps UC en cas d'arrivee du message associe
