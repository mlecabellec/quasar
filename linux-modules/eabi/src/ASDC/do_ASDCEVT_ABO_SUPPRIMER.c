...
ASDCEVT_ABO_AJOUTER : Fonction ioctl de deconnexion d'une sous-adresse a un CEVT.
...
long
do_ASDCEVT_ABO_SUPPRIMER(int vfxNum, int asdcNum, struct asdc_varg *dst, unsigned long arg)
{
    int zd;
