...
int init_cevt(void) {
  ...
  ASDC_registerCEVTDriver(cevtioctl, cevt_existence_impl, cevt_signaler_impl,
                          cevt_signaler_date_impl);
...
/*                                                                       */
/*************************************************************************/
int cevt_signaler_impl(int numero_cevt,
...
int cevt_signaler_date_impl(
    int numero_cevt, int nature_es, /* CEVT_ETOR, CEVT_1553, etc... */
    int numero_es,                  /* numero voie/coupleur */
