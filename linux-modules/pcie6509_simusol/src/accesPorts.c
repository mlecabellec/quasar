...
uint8_t
lirePortEntree(pcie6509Statics_t * pstat, int port)
{
    uint8_t r;
...
void
ecrirePortSortie(pcie6509Statics_t * pstat, int port, uint8_t valeur)
{
    uint32_t data;
    int i;
    int p;
...
void
ecrirePortDirection(pcie6509Statics_t * pstat, int port, uint8_t valeur)
{
    uint32_t data;
    int i;
    int p;
