 ...
 *                                               modif. le 10/10/2002   *
 *         Ajout definition CEVT_TIMER : X. Schimowski, le 13/01/2003   *
 *      Ajout definition CEVT_ABOSUPPR : X. Schimowski, le  6/03/2003   *
 *                    Ajout definition CEVT_STOR : ???, le 22/05/2003   * 
 *                   Adaptation a Linux : Y. Guillemot, le 18/10/2006   *
...
struct cevt_lire { int type_evt; /* Mode lect. (entree) - Nature evt (sortie)*/
...
struct cevt_signal { long d1;	/* Premier mot de données */
                     long d2;	/* Second mot de données */
                   };
...
/* ifonction cevt exportée vers les modules utilisateurs */
